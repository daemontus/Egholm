 ...
 * Throws IllegalStateException if the value is an Ok, with a custom panic message provided by the Ok's value.
 */
 ...
 * Throws IllegalStateException if the value is an Err, with a custom panic message provided by the Err's value.
 */
